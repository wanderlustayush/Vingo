    ...
    >
      ...
      >
        ...
        <div className='mb-4'>
          ...
          border: `1px solid ${borderColor}`}} onChange={(e)=>setFullName(e.target.value)} value={fullName} required/>
        </div>
        ...
        <div className='mb-4'>
            ...
            <input type="mobile" className='w-full border rounded-lg px-3 py-2 focus:outline-none ' placeholder='Enter your mobile' style={{
          border: `1px solid ${borderColor}`}} onChange={(e)=>setMobile(e.target.value)} value={mobile} required/>
        </div>
...
{err && <p className='text-red-500 text-center my-[2px]'>*{err}</p>}
     ...
     <span>
        ...
        <p className='text-center mt-2 cursor-pointer' onClick={()=>navigate("/signin")}>
            Already have an account ? <span className='text-[#ff4d2d]'>
                Sign In
            </span>
        </p>
